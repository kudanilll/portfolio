...
//         <div className="mx-2 hidden md:block border">
//           <Image
//             src={item.src}
//             alt={item.alt}
//             width="96"
//             height="96"
//             loading="lazy"
//             className="m-4 grayscale hover:grayscale-0 transition-all duration-500 ease-in-out"
//           />
//         </div>
//         <Image
//           src={item.src}
...
//       </Marquee>
//       <Marquee className="overflow-hidden mt-4" direction="right">
